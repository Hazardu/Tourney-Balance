...
function mod.talent_changes_apply(self)
	-- Footknight Talents
	...
	-- 		if talent_extension:has_talent("gs_bardin_slayer_passive_stacking_crit", "dwarf_ranger", true) and talent_extension:has_talent("gs_bardin_slayer_passive_increased_max_stacks", "dwarf_ranger", true) == false then
	-- 			buff_system:add_buff(owner_unit, "gs_bardin_slayer_passive_stacking_crit_buff", owner_unit, false)
	-- 		end

	-- 		if talent_extension:has_talent("gs_bardin_slayer_passive_stacking_crit", "dwarf_ranger", true) and talent_extension:has_talent("gs_bardin_slayer_passive_increased_max_stacks", "dwarf_ranger", true) then
	...
	-- 	multiplier = 0.05
	-- })
	-- mod:add_talent("dr_slayer", 4, 2, "gs_bardin_slayer_passive_stacking_crit", {
